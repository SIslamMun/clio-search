#!/bin/bash
#PBS -N clio_agent_v6h
#PBS -l select=15:ngpus=6
...
RUN_DIR=/lus/flare/projects/gpu_hack/sislam6/clio_eval/results/v6h_${DATASET}_${ARM}_${RUN_TS}
mkdir -p $RUN_DIR

NUM_NODES=$(wc -l < $PBS_NODEFILE)
echo "v6 HEAVY (15 ranks/arm) dataset=$DATASET arm=$ARM nodes=$NUM_NODES run_dir=$RUN_DIR"
