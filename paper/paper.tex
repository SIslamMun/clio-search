...
\textbf{Gap.} To our knowledge, no existing retrieval system performs arithmetic SI conversion to canonicalize measurements. None combines quantity matching with formula normalization. None operates across federated HPC backends.
