...
Full pipeline (ours)   & 0.97 & 1.00 & 0.98 & 1.00 \\
\bottomrule
\end{tabular}
\end{table}
...
C: +Scientific & B + dimensional + formula ops.     & 0.98 \\
D: +Graph      & C + entity-rel.\ traversal        & 0.98 \\
E: +Agentic    & D + multi-hop query rewriting      & 0.98 \\
F: Full        & E + all optimizations              & 0.98 \\
\bottomrule
\end{tabular}
\end{table}
