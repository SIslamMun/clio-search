...
\begin{table*}[!t]
\centering
\caption{Capability comparison of retrieval and scientific data systems. Columns 1--5 correspond to our contributions. \cmark{} = supported, \xmark{} = not supported, $\circ$ = partial.}
...
\cmidrule(lr){2-6} \cmidrule(lr){7-11}
 & \rotatebox{70}{\textbf{SI conversion}} & \rotatebox{70}{\textbf{Formula norm.}} & \rotatebox{70}{\textbf{Science branches}} & \rotatebox{70}{\textbf{Federated backends}} & \rotatebox{70}{\textbf{HDF5/NetCDF index}} & \rotatebox{70}{\textbf{Agentic multi-hop}} & \rotatebox{70}{\textbf{Quantity extraction}} & \rotatebox{70}{\textbf{Paper search}} & \rotatebox{70}{\textbf{Data search}} & \rotatebox{70}{\textbf{LLM integration}} \\
\midrule
\rowcolor{gray!10}
\textbf{Ours}        & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \cmark & \xmark & \cmark & \cmark \\
...
\midrule
\rowcolor{gray!10}
Full pipeline (ours)   & \textbf{0.97} & \textbf{1.00} & \textbf{0.98} & \textbf{1.00} \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
A: Lexical     & BM25                              & 0.42 \\
B: +Vector     & A + dense embeddings              & 0.45 \\
\midrule
\rowcolor{gray!10}
C: +Scientific & B + dimensional + formula ops.     & \textbf{0.98} \\
D: +Graph      & C + entity-rel.\ traversal        & \textbf{0.98} \\
E: +Agentic    & D + multi-hop query rewriting      & \textbf{0.98} \\
F: Full        & E + all optimizations              & \textbf{0.98} \\
\bottomrule
\end{tabular}
\end{table}
