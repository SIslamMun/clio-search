...
We further evaluate the agentic loop across 8 configurations spanning four inference backends: Ollama (local GPU), Gemini (cloud API), Claude (session-based), and a no-LLM fallback (Table~\ref{tab:llm_providers}).
