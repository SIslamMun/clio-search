...
50K & 5{,}082\,s & 44\,ms & 137{,}500 & 50 & 12{,}500 (all) \\
\bottomrule
\end{tabular}
\end{table}
...
from 5.0\% at 1K to \textbf{0.1\% at 50K} ($250\times$ reduction over
BlobQuery). Corpus profiling scales sub-linearly: 14\,ms at 1K to
44\,ms at 50K (a $50\times$ data increase produces only a $3\times$
profiling increase). The 100K scale was not reached due to IOWarp's
shared-memory limit (16\,GB) in the Docker test environment.
...
Different unit expressions for the same physical quantity return
identical hit counts across 4~GH200 nodes.}
