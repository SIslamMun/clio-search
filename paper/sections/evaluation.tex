...
work. The arXiv evaluation verifies cross-unit correctness and latency
but does not report P@5 because no ground-truth relevance judgments
exist for this corpus. The controlled benchmark (210~documents) is
synthetic; the NOAA evaluation (288~real documents) partially addresses
ecological validity.
