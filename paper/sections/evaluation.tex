...
\begin{table}[t]
\centering
\caption{CLIO vs.\ raw BlobQuery on IOWarp blobs (DeltaAI GH200).
CLIO returns top-50 unit-converted matches; BlobQuery returns all
blobs unfiltered. All cross-unit queries succeed at every scale.}
\label{tab:iowarp}
\small
...
\midrule
1K   & 163\,s   & 17\,ms & 2{,}500   & 50 & 250 (all) \\
5K   & 348\,s   & 16\,ms & 12{,}500  & 50 & 1{,}250 (all) \\
10K  & 822\,s   & 27\,ms & 25{,}000  & 50 & 2{,}500 (all) \\
50K  & 4{,}718\,s & 45\,ms & 125{,}000 & 50 & 12{,}500 (all) \\
100K & 9{,}801\,s & 51\,ms & 250{,}000 & 50 & 25{,}000 (all) \\
\bottomrule
\end{tabular}
\end{table}
...
\caption{IOWarp scaling: corpus profiling time (left axis) grows
sub-linearly while inspection rate (right axis) drops from 5\% to
0.1\% as blob count increases from 1K to 50K.}
