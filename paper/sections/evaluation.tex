...
IOWarp is a distributed I/O middleware for HPC that manages scientific
data as blobs organized in tags across tiered storage (RAM, NVMe,
parallel filesystem). At its target scale of 10~billion blobs, the
native BlobQuery API returns all blobs matching a tag regex with no
content filtering. CLIO
