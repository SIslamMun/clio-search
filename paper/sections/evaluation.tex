...
distributed corpus (4~shards on DeltaAI GH200). Fig.~\ref{fig:d4-correctness} shows that querying in different units
...
and 303.15~K all return exactly 20~hits at sub-50\,ms latency. This
confirms that SI canonicalization is consistent across shards.
...
20~queries return results with \textbf{100\% hit rate} at p50 latency
of 42\,ms, demonstrating that CLIO's unit registry generalizes beyond
the controlled benchmark to real scientific literature.
