...
IOWarp is an NSF-funded open-source platform for managing scientific
data at HPC scale. Its core engine organizes data as blobs within
tags across tiered storage (RAM, NVMe, parallel filesystem), deployed
at national laboratories including LLNL and ANL. At IOWarp's target scale of 10~billion blobs,
the native BlobQuery API returns all blobs matching a tag regex with
no content filtering. CLIO
