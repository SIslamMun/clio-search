...
\begin{table}[t]
\centering
\caption{CLIO on IOWarp blobs (DeltaAI GH200): rich metadata
(2.5~meas/blob) and sparse metadata (0.75~meas/blob). CLIO returns
...
\toprule
\textbf{Blobs} & \textbf{Variant} & \textbf{Index} & \textbf{Profile} & \textbf{Meas.} & \textbf{CLIO} & \textbf{BlobQ.} \\
\midrule
1K   & rich   & 163\,s   & 17\,ms & 2{,}500   & 50 & 250 \\
\rowcolor{gray!5}
1K   & sparse &  58\,s   & 11\,ms &    750    & 50 & 250 \\
10K  & rich   & 822\,s   & 27\,ms & 25{,}000  & 50 & 2{,}500 \\
\rowcolor{gray!5}
10K  & sparse & 702\,s   & 33\,ms &  7{,}500  & 50 & 2{,}500 \\
100K & rich   & 9{,}801\,s & 51\,ms & 250{,}000 & 50 & 25{,}000 \\
\rowcolor{gray!5}
100K & sparse & 8{,}068\,s & 47\,ms &  75{,}000 & 50 & 25{,}000 \\
\bottomrule
\end{tabular}
\end{table}
...
from 5.0\% at 1K to \textbf{0.05\% at 100K} ($500\times$ reduction
over BlobQuery). Corpus profiling scales sub-linearly: 100$\times$
data growth (1K to 100K) produces only $3.6\times$ profiling increase
(17\,ms to 51\,ms on GH200).

\begin{figure}[t]
\centering
\includegraphics[width=0.85\columnwidth]{figures/fig_iowarp_scaling.png}
...
1K to 100K blobs. Both converge to 0.05\% inspection at 100K.}
